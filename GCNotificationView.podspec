#
# Be sure to run `pod lib lint GCNotificationView.podspec' to ensure this is a
...
This library is for the developer who is lazy enought.
  ...
  s.source_files = 'GCNotificationView/Classes/**/*'
  
  # s.resource_bundles = {
  #   'GCNotificationView' => ['GCNotificationView/Assets/*.png']
  # }
